...
const moduleContent: Module = {
  ...
  icon: "🧠",
  color: "#9F99EB",
  workbookUrl: "/workbooks/0-mindset.pdf",
  paliers: [
    {
      id: "0.0",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {moduleContent.workbookUrl && (
            <div className="bg-surfaceMedium rounded-2xl p-8 border border-border" style={{ borderColor: `${moduleContent.color}40` }}>
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 rounded-lg" style={{ backgroundColor: `${moduleContent.color}20` }}>
                  <svg className="w-6 h-6" style={{ color: moduleContent.color }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
                <h2 className="text-2xl font-bold" style={{ color: moduleContent.color }}>
                  Workbook du module
                </h2>
              </div>
              <p className="text-textSecondary mb-6">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 rounded-lg transition-colors"
                style={{ 
                  backgroundColor: moduleContent.color,
                  color: '#000000'
                }}
              >
                <svg className="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
