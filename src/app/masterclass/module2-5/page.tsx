      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-surfaceMedium/50 backdrop-blur-sm rounded-2xl p-8 border border-white/5 shadow-2xl mb-8">
            ...
            {/* Liste des rubriques avec une meilleure différenciation visuelle */}
            <div className="space-y-16">
              {moduleContent.rubriques?.map((rubrique) => (
                <div key={rubrique.id} className="space-y-6">
                  {/* En-tête de la rubrique avec style distinctif */}
                  <div className="relative">
                    <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-1 h-12 bg-primary rounded-full"></div>
                    <div className="pl-6">
                      <h2 className="text-3xl font-bold text-white mb-2">{rubrique.title}</h2>
